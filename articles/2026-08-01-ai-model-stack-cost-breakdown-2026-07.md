...
### GPT-5.6で価格の下限が一気に下がった

OpenAIは7月9日、GPT-5.6 Sol、Terra、LunaをChatGPT、Codex、APIへ展開しました。100万トークンあたりの通常入力・出力料金は、Solが**$5 / $30**、Terraが**$2.50 / $15**、Lunaが**$1 / $6**です。

GPT-5.5の$5 / $30と比べると、Terraは入出力とも**50%安く**、Lunaは**80%安い**価格です。Sol自体が値下げされたわけではありませんが、OpenAI公式はTerraをGPT-5.5と競争力のある性能を持つ層と説明しています。つまり、近い性能帯をより安い階層へ移したことで、実用上の価格下限が大幅に下がりました。
