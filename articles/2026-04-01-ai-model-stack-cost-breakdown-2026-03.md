...
この月あたりから、API課金が通常のサブスクよりも高額になってきました。そのため、APIを直接叩く運用から、Claudeの月額200ドルプラン（税抜\$200、日本の消費税10%込み\$220）と、ChatGPTの\$200プランへ切り替え、できるだけそちら経由で使う運用を始めました。
...
この月をきっかけに、Claudeの月額200ドルプラン（税抜\$200、日本の消費税10%込み\$220）とChatGPTの\$200プランを契約し、APIに直接流していた作業をできるだけサブスク経由へ移す方針に切り替えました。APIは必要な自動化や連携に絞って使っていきます。
